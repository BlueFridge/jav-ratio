public class Ratio
{
	...
	//Add two ratios (needs improvement)
	public Ratio add(Ratio rat)
	{
		...
		int new_num = a+b;
		/*
		 * Can be improved by simplifying.
		 * Compute HCF of new_num and new_den
		 * Divide new_num and new_den by the HCF
		 */
		Ratio result = new Ratio(new_num, new_den);
		return result;
	}
	
	//Subtract two ratios (needs improvement)
